...
const containsAnd = (arr) => {
  let yazan =arr.filter(value => value.includes('and'));
  return yazan ;};
...
//   let array = [];
//   array = arr.filter((val) =>{
//     if (val !== forbiddenValues[0] && val !== forbiddenValues[1] && val !== forbiddenValues[2]){
//       return 1;
//     }
//   });
//   return array;
...
const notInFirstArray = (forbiddenValues, arr) => {
  let array=arr.filter((value)=>{
    if(forbiddenValues.includes(value)===false){
      return true;
    }
    else {return false;}
...
const getBaseStatGreaterThan = (_arr, _minBaseStat) => {
  // Solution code here...
};
...
const getStatName = (_arr, _minBaseStat) => {
  // Solution code here...
};
...
const getCharactersWithoutChildren = (_arr) => {
  // Solution code here...
};
...
const evenOddNumericValues = (_arr) => {
  // Solution code here...
};
